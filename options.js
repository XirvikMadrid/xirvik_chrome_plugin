    ...
    my.options = {
        ...
        setRows: function() {
            ...
            rows.off('mouseenter mouseleave').hover(function() {
                ...
                $('td', this).css({
                    backgroundColor: $(this).hasClass('current') ? '' : 'white'
                });
            });
        ...
        sync: function() {
            my.extension.options = {
                ...
                capture: $('#context-capture-on').prop('checked') ? 0 : $('#context-capture-force').prop('checked') ? 1 : 2,
                servers: []
            };
